...
class week6_lecture-31_ber(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "week6_lecture-31_ber")
...
def main(top_block_cls=week6_lecture-31_ber, options=None):
