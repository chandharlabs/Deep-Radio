...
class week8_lecture37_delay estimation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "week8_lecture37_delay estimation")
...
def main(top_block_cls=week8_lecture37_delay estimation, options=None):
