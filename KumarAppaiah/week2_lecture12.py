...
class week2_lecture12(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "week2_lecture12")
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_fff((samp_rate // 1000), numpy.ones(samp_rate // 1000))
        self.interp_fir_filter_xxx_0.declare_sample_delay(0)
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_if([1,2], 2)
        self.blocks_vco_f_0 = blocks.vco_f(samp_rate, (2*numpy.pi*1000), 1)
...
def main(top_block_cls=week2_lecture12, options=None):
