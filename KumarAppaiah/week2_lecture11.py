...
class week2_lecture11(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "week2_lecture11")
        ...
        self.low_pass_filter_1 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_ccc((samp_rate//1000), numpy.ones(samp_rate//1000))
        self.interp_fir_filter_xxx_0.declare_sample_delay(0)
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_ic([a+1j * b for a in (numpy.arange(8)-3.5)  for b in (numpy.arange(8)-3.5)], 1)
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fc, (-1.414), 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fc, 1.414, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.interp_fir_filter_xxx_0.set_taps(numpy.ones(self.samp_rate//1000))
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate, self.fc, 1000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_1_0.set_taps(firdes.low_pass(1, self.samp_rate, self.fc, 1000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=week2_lecture11, options=None):
