...
class week7_lecture32(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "week7_lecture32")
        ...
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(np.sqrt(sps), samp_rate,8000, 0.35, (11*sps))
        ...
        self._noisestd_range = Range(0, 10, 0.01, 0, 200)
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, fc, (-1.414), 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_rrc_taps(firdes.root_raised_cosine(np.sqrt(self.sps), self.samp_rate, 8000, 0.35, (11*self.sps)))
...
def main(top_block_cls=week7_lecture32, options=None):
