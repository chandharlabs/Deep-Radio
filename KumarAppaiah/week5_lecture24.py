...
class week5_lecture24(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "week5_lecture24")
        ...
        self.my_constell = my_constell = digital.constellation_bpsk().base()
        self.delay = delay = 0
        ...
        self.fir_filter_xxx_0 = filter.fir_filter_ccc(sps, rrc_taps[::1])
        self.fir_filter_xxx_0.declare_sample_delay(0)
        self.digital_constellation_encoder_bc_0 = digital.constellation_encoder_bc(my_constell)
    ...
    def set_rrc_taps(self, rrc_taps):
        ...
        self.fir_filter_xxx_0.set_taps(self.rrc_taps[::1])
        self.interp_fir_filter_xxx_0.set_taps(self.rrc_taps)

    def get_my_constell(self):
        return self.my_constell

    def set_my_constell(self, my_constell):
        self.my_constell = my_constell
        self.digital_constellation_encoder_bc_0.set_constellation(self.my_constell)
...
def main(top_block_cls=week5_lecture24, options=None):
