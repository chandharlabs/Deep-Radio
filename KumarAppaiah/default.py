...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.sps = sps = samp_rate // 8000
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(4.89, samp_rate,8000, 0.35, (11*sps))
        self.random_delay = random_delay = np.random.randint(0,sps)
        self.noisestd = noisestd = 0.01
        self.mypulse = mypulse = rrc_taps
        self.myconst = myconst = digital.constellation_calcdist([-1-1j, -1+1j, 1+1j, 1-1j], [0, 1, 3, 2],
        4, 1, digital.constellation.AMPLITUDE_NORMALIZATION).base()
        self.comp_delay = comp_delay = 0

        ##################################################
        # Blocks
        ##################################################

        self._noisestd_range = Range(0, 100, 0.1, 0.01, 200)
        ...
        self._comp_delay_range = Range(0, sps, 1, 0, 200)
        self._comp_delay_win = RangeWidget(self._comp_delay_range, self.set_comp_delay, "'comp_delay'", "counter_slider", int, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._comp_delay_win)
        ...
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_ccc(sps, mypulse)
        self.interp_fir_filter_xxx_0.declare_sample_delay(0)
        self.fir_filter_xxx_1 = filter.fir_filter_ccc(1, mypulse[::-1])
        self.fir_filter_xxx_1.declare_sample_delay(0)
        self.fir_filter_xxx_0 = filter.fir_filter_ccc(sps, mypulse[::-1])
        self.fir_filter_xxx_0.declare_sample_delay(0)
        self.digital_constellation_encoder_bc_0 = digital.constellation_encoder_bc(myconst)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_gr_complex*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_delay_0_0 = blocks.delay(gr.sizeof_gr_complex*1, random_delay)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, (sps-comp_delay))
        ...
        self.connect((self.blocks_complex_to_imag_0, 0), (self.qtgui_time_sink_x_1, 0))
        ...
        self.connect((self.fir_filter_xxx_1, 0), (self.blocks_complex_to_imag_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_rrc_taps(firdes.root_raised_cosine(4.89, self.samp_rate, 8000, 0.35, (11*self.sps)))
        self.set_sps(self.samp_rate // 8000 )
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_random_delay(np.random.randint(0,self.sps))
        self.set_rrc_taps(firdes.root_raised_cosine(4.89, self.samp_rate, 8000, 0.35, (11*self.sps)))
        self.blocks_delay_0.set_dly(int((self.sps-self.comp_delay)))
    ...
    def set_rrc_taps(self, rrc_taps):
        ...
        self.set_mypulse(self.rrc_taps)

    def get_random_delay(self):
        return self.random_delay

    def set_random_delay(self, random_delay):
        self.random_delay = random_delay
        self.blocks_delay_0_0.set_dly(int(self.random_delay))
    ...
    def get_mypulse(self):
        return self.mypulse

    def set_mypulse(self, mypulse):
        self.mypulse = mypulse
        self.fir_filter_xxx_0.set_taps(self.mypulse[::-1])
        self.fir_filter_xxx_1.set_taps(self.mypulse[::-1])
        self.interp_fir_filter_xxx_0.set_taps(self.mypulse)
    ...
    def set_comp_delay(self, comp_delay):
