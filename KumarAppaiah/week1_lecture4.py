...
class week1_lecture4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "week1_lecture4")
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_float_to_complex_0_1, 0))
...
def main(top_block_cls=week1_lecture4, options=None):
