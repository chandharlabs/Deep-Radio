...
class Week8_lecture40_costas(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Week8_lecture40_costas")
        ...
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(4.9, samp_rate,8000, 0.35, (11*sps))
        ...
        self._noisestd_range = Range(0, 3, 0.01, 0.01, 200)
        ...
        self._delta_f_range = Range(-20, 20, 1, 0, 200)
        ...
        self._delay_range = Range(0, sps, 1, 9, 200)
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, (fc+delta_f), (-1.414), 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, (fc+delta_f), 1.414, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_rrc_taps(firdes.root_raised_cosine(4.9, self.samp_rate, 8000, 0.35, (11*self.sps)))
    ...
    def set_fc(self, fc):
        ...
        self.analog_sig_source_x_1.set_frequency((self.fc+self.delta_f))
        self.analog_sig_source_x_1_0.set_frequency((self.fc+self.delta_f))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.fc, 1000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, self.fc, 1000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=Week8_lecture40_costas, options=None):
