...
class week2_lecture7(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "week2_lecture7")
        ...
        self._fc_range = Range(3000, 8000, 1, 3000, 200)
...
def main(top_block_cls=week2_lecture7, options=None):
