...
class week1_lecture2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "week1_lecture2")
        ...
        self._freq_range = Range(100, 16000, 1, 100, 200)
...
def main(top_block_cls=week1_lecture2, options=None):
