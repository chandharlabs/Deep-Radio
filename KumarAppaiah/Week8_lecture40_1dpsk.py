...
class Week8_lecture40_1dpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Week8_lecture40_1dpsk")
        ...
        self._delta_f_range = Range(-10, 10, 0.1, 0, 200)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.digital_diff_phasor_cc_0, 0))
        ...
        self.connect((self.digital_diff_phasor_cc_0, 0), (self.qtgui_const_sink_x_0, 1))
...
def main(top_block_cls=Week8_lecture40_1dpsk, options=None):
