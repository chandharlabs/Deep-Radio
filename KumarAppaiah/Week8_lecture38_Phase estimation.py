...
class Week8_lecture38_Phase estimation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Week8_lecture38_Phase estimation")
        ...
        self.phase_offset = phase_offset = 3.141
        ...
        self._delay_range = Range(0, sps, 1, 0, 200)
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fc, (-1.414), phase_offset, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fc, 1.414, phase_offset, 0)
    ...
    def set_phase_offset(self, phase_offset):
        ...
        self.analog_sig_source_x_1.set_offset(self.phase_offset)
        self.analog_sig_source_x_1_0.set_offset(self.phase_offset)
...
def main(top_block_cls=Week8_lecture38_Phase estimation, options=None):
