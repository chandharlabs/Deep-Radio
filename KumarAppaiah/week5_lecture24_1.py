...
class week5_lecture24_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "week5_lecture24_1")
        ...
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(sps **0.5, samp_rate,samp_rate //sps, excess_bw, (11*sps))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_rrc_taps(firdes.root_raised_cosine(self.sps **0.5, self.samp_rate, self.samp_rate //self.sps, self.excess_bw, (11*self.sps)))
...
def main(top_block_cls=week5_lecture24_1, options=None):
