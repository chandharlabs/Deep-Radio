...
class week3_lecture14(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_fff(2, [1,-1])
        self.interp_fir_filter_xxx_0.declare_sample_delay(0)
        self.fir_filter_xxx_0 = filter.fir_filter_fff(2, [1,0])
        self.fir_filter_xxx_0.declare_sample_delay(0)
        self.blocks_vector_source_x_0 = blocks.vector_source_f([1,-1,3,2], True, 1, [])
