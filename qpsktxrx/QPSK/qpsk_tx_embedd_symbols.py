...
class blk(gr.sync_block):
    def __init__(self, file_path="/home/chandharlabs/Downloads/HackrfONE_RTLSDR_demo-main(1)/HackrfONE_RTLSDR_demo-main/test.txt", preamble_len=100):
        ...
        np.save(os.path.join(save_dir, "/home/chandharlabs/Downloads/tx_bits.npy"), bit_array)
        with open("/home/chandharlabs/Downloads/tx_bits.txt", "w") as f:
