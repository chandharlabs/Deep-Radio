...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._vol3_win = RangeWidget(self._vol3_range, self.set_vol3, 'Jaime Ross', "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._vol3_win)
        self._vol2_range = Range(0, 1, .1, 0, 200)
        self._vol2_win = RangeWidget(self._vol2_range, self.set_vol2, 'Microfono', "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._vol2_win)
        self._vol1_range = Range(0, 1, .1, 0, 200)
        self._vol1_win = RangeWidget(self._vol1_range, self.set_vol1, 'Sumo', "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.soapy_plutosdr_sink_0 = soapy.sink(dev, "fc32", 1, "ip:192.168.2.1",
                                  stream_args, tune_args, settings)
        self.soapy_plutosdr_sink_0.set_sample_rate(0, samp_rate)
        self.soapy_plutosdr_sink_0.set_bandwidth(0, 2e6)
        self.soapy_plutosdr_sink_0.set_frequency(0, 104e6)
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HANN,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('E:\\CRL\\SDR_Workshop\\PlutoSDR\\testMusic.wav', True)
        ...
        self.connect((self.rational_resampler_xxx_0_0, 0), (self.soapy_plutosdr_sink_0, 0))
    ...
    def set_audio_rate(self, audio_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.audio_rate, 24000, 1000, window.WIN_HANN, 6.76))
