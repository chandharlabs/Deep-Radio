...
# File that contains classes and functions to prepare training and validation data 
...
# Define the function that prepares training and validation data objects
