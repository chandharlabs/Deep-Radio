...
# Generated: Sun Nov 24 01:09:51 2019
##################################################
...
class ssb_rx(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.band_pass_filter = filter.fir_filter_ccc(5, firdes.complex_band_pass(
        	1, samp_rate, low, high, trans, firdes.WIN_HAMMING, 6.76))
        ...
        # Connections
        ##################################################
        self.connect((self.band_pass_filter, 0), (self.rational_resampler_xxx_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter.set_taps(firdes.complex_band_pass(1, self.samp_rate, self.low, self.high, self.trans, firdes.WIN_HAMMING, 6.76))
