...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.soapy_limesdr_sink_0.set_sample_rate(0, 500e3)
        self.soapy_limesdr_sink_0.set_bandwidth(0, 2e6)
        self.soapy_limesdr_sink_0.set_frequency(0, 660e6)
        self.soapy_limesdr_sink_0.set_frequency_correction(0, 0)
        self.soapy_limesdr_sink_0.set_gain(0, min(max(50.0, -12.0), 64.0))
        ...
        self.connect((self.rational_resampler_xxx_0_0, 0), (self.soapy_limesdr_sink_0, 0))
    ...
    def set_audio_rate(self, audio_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.audio_rate, 24000, 1000, window.WIN_HAMMING, 6.76))
