############ FFT (Welch PSD) Based Decision Tree Training #############
...
# =============== Welch PSD feature config (match other models) ===============
FEATURE_CFG = {
    "nperseg": 4096,
    "noverlap": 2048,
    "window": "hann",
...
# Decision Tree (you can tune max_depth/min_samples_* later)
...
pickle.dump(
    ...
    open('model_dt_welchpsd.sav', 'wb')
)

print("\nSaved model: model_dt_welchpsd.sav")
