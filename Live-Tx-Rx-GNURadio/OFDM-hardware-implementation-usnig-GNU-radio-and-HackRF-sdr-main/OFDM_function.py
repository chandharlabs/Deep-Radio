...
class OFDM_function(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.carriers = carriers = (list(range(-(int(fft_len/2) - 3), 0))+list(range(1, int((fft_len/2) -2))),)
        ...
        self.connect((self.rtlsdr_source_0, 0), (self.digital_ofdm_rx_0, 0))
    ...
    def set_fft_len(self, fft_len):
        ...
        self.set_carriers((list(range(-(int(self.fft_len/2) - 3), 0))+list(range(1, int((self.fft_len/2) -2))),))
