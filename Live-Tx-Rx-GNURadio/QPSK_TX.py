...
class QPSK_TX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._freq_range = Range(500000000, 1500000000, 1, 915014100, 200)
        ...
        self.epy_block_0 = epy_block_0.blk(file_path="/home/deepradio/Downloads/HackrfONE_RTLSDR_demo-main(1)/HackrfONE_RTLSDR_demo-main/test.txt", preamble_len=100)
        ...
        self.connect((self.epy_block_0, 0), (self.digital_diff_encoder_bb_0, 0))
