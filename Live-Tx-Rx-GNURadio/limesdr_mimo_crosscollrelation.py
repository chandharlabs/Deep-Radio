...
center_freq = 947.8e6
rx_gain = 60
n_samples = 32768  # Reduced to avoid underruns
antenna_spacing = 4  # meters
c = 3e8
wavelength = c / center_freq
plot_window = 100  # Plot window length (frames)
plot_every_n = 1
median_filter_len = 5
avg_window_len = 30  # Number of recent delays to average
...
# Delay plot (instantaneous + moving average)
delay_series = []
avg_delay_series = []
