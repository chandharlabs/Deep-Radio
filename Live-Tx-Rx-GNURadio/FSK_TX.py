...
class FSK_TX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.tx_gain_0 = tx_gain_0 = 60
        self.tx_gain = tx_gain = 20
        self.tx_frequency = tx_frequency = 914999424
        self.sps = sps = 100
        ...
        self._tx_frequency_range = Range(914000000, 915016000, 1, 914999424, 200)
        self._tx_frequency_win = RangeWidget(self._tx_frequency_range, self.set_tx_frequency, "TX Frequency", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._tx_frequency_win)
        self._tx_gain_0_range = Range(10, 64, 1, 60, 200)
        self._tx_gain_0_win = RangeWidget(self._tx_gain_0_range, self.set_tx_gain_0, "TX GAIN", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._tx_gain_0_win)
        ...
        self.soapy_limesdr_sink_0.set_frequency(0, tx_frequency)
    ...
    def get_tx_gain_0(self):
        return self.tx_gain_0

    def set_tx_gain_0(self, tx_gain_0):
        self.tx_gain_0 = tx_gain_0
    ...
    def set_tx_frequency(self, tx_frequency):
        ...
        self.soapy_limesdr_sink_0.set_frequency(0, self.tx_frequency)
