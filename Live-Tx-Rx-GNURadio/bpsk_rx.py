...
import bpsk_rx_epy_block_0 as epy_block_0  # embedded python block
import osmosdr
import time
...
class bpsk_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "BPSK RECEIVER", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BPSK RECEIVER")
        ...
        # Blocks
        ##################################################
        self._rx_gain_range = Range(0, 70, 1, 40, 200)
        ...
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.low_pass_filter_0_0, 0))
