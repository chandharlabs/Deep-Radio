...
class blk(gr.sync_block):
    def __init__(self, file_path="/home/deepradio/Downloads/HackrfONE_RTLSDR_demo-main(1)/HackrfONE_RTLSDR_demo-main/test.txt", preamble_len=100):
        ...
        np.save(os.path.join(save_dir, "tx_bits.npy"), bit_array)
        with open("tx_bits.txt", "w") as f:
